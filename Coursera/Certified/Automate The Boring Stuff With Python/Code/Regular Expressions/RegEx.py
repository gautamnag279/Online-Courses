...
print('')
print('IP Adressess obtained from the file are:')
ipAddress = re.compile(r'\d\d\d.\d\d\d.\d\d.\d\d')
print(ipAddress.findall(message))

print('')
print('Time Stamps are:')
timeStamp = re.compile(r'\d\d:\d\d:\d\d')
print(timeStamp.findall(message))

print('')
print('Date Stamps are:')
dateStamp = re.compile(r'\d\d\d\d-\d\d-\d\d')
print(dateStamp.findall(message))
